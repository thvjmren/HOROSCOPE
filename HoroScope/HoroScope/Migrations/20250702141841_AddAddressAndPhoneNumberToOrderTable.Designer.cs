...
namespace HoroScope.Migrations
{
    ...
    [Migration("20250702141841_AddAddressAndPhoneNumberToOrderTable")]
    partial class AddAddressAndPhoneNumberToOrderTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HoroScope.Models.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoroScope.Models.Order", b =>
                {
                    b.HasOne("HoroScope.Models.AppUser", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("HoroScope.Models.OrderItem", b =>
                {
                    b.HasOne("HoroScope.Models.Order", "Order")
                        .WithMany("OrderItems")
